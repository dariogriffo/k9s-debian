...
(.deb) for [k9s](https://github.com/derailed/k9s) hosted at [debian.griffo.io](https://debian.griffo.io)

<p align="center">
⭐⭐⭐ Love using k9s on Debian? Show your support by starring this repo or [subscribing](https://buy.stripe.com/aFa28q8hr0lRdlm4a2enS01) — access to this repository requires a yearly subscription. ⭐⭐⭐
</p>
...
📖 **Step-by-step install guide:** [Debian](https://debian.griffo.io/install-latest-k9s-in-debian.html) · [Ubuntu](https://debian.griffo.io/install-latest-k9s-in-ubuntu.html)
